 ...
 */
public class LWAAuthorizationSigner implements AuthorizationSigner {
    ...
    public LWAAuthorizationSigner(
            LWAAuthorizationCredentials lwaAuthorizationCredentials, LWAAccessTokenCache lwaAccessTokenCache) {
