...
public class ApiClient {
    ...
    public static final String AUTHORIZATION_SIGNER = "AUTHORIZATION_SIGNER";

    public static final String TEMP_FOLDER_PATH = "TEMP_FOLDER_PATH";

    public static final String DEFAULT_HEADER_MAP = "DEFAULT_HEADER_MAP";
    ...
    public ApiClient(OkHttpClient httpClient) {
        this(httpClient, new JSON());
    }

    public ApiClient(OkHttpClient httpClient, JSON json) {
    ...
    public ApiClient setLWAAuthorizationSigner(LWAAuthorizationSigner lwaAuthorizationSigner) {
        setContext(ApiClient.AUTHORIZATION_SIGNER, lwaAuthorizationSigner);
        return this;
    }
    ...
    public File prepareDownloadFile(Response response) throws IOException {
        ...
        String tempFolderPath = getContextValue(TEMP_FOLDER_PATH);
    ...
    public Request buildRequest(
        ...
        AuthorizationSigner authorizationSigner = getContextValue(AUTHORIZATION_SIGNER);
        request = authorizationSigner.sign(request);
    ...
    public String buildUrl(String path, List<Pair> queryParams, List<Pair> collectionQueryParams) {
        ...
        String contextValue = getContextValue(ApiClient.BASE_PATH);
        url.append(contextValue).append(path);
    ...
    public void processHeaderParams(Map<String, String> headerParams, Request.Builder reqBuilder) {
        ...
        for (Entry<String, String> header : getDefaultHeaderMap().entrySet()) {
    ...
    private static final ThreadLocal<Map<String, Object>> contextHolder = ThreadLocal.withInitial(LinkedHashMap::new);
    ...
    public <V> V getContextValue(String key) {
        return (V) contextHolder.get().get(key);
    }

    private Map<String, String> getDefaultHeaderMap() {
        Map<String, String> contextValue = getContextValue(DEFAULT_HEADER_MAP);
        if (contextValue == null) {
            return Collections.emptyMap();
        }
        return getContextValue(DEFAULT_HEADER_MAP);
    }
